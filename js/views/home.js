 ...
 */
export default function home ({ req, res, session }) {
  ...
  res.body = html`
      ...
      !${todos.length !== 0 && (html`
            ...
            !${listTodos.map(todo => html`
              <li data-key="${todo.id}" class="${cx({ completed: todo.completed, editing: todo.editing })}">
                <div class="view">
                  ...
                  <a href="/todo/open/${todo.id}"><label>${todo.text}</label></a>
                  <form action="/todo/remove/${todo.id}">
                ...
                !${todo.editing && html`
                  <form action="/todo/update/${todo.id}" method="POST">
                    ...
                    <a style="z-index:998;position:fixed;top:0;bottom:0;left:0;right:0" href="/todo/close/${todo.id}"></a>
        ...
        <footer class="footer">
          ...
          <form action="/todo/remove-completed">
